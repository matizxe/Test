...
I am **ᴘᴏsᴛ sᴇᴀʀᴄʜ ʙᴏᴛ**.I am best Channel Link Search Bot! 
I Will filter your channel posts automatically and send it in your group chat when Someone search it.
For More Info Click /help</b>"""

    HELP = """<b>‼️ ʜᴏᴡ ᴛᴏ ᴜꜱᴇ ᴍᴇ ɪɴ ᴀ ɢʀᴏᴜᴘ ‼️


❂ ᴀᴅᴅ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ & ᴄʜᴀɴɴᴇʟ ᴡɪᴛʜ ᴀʟʟ ᴘᴇʀᴍɪꜱꜱɪᴏɴꜱ..

❂ ꜱᴇɴᴅ /verify ɪɴ ɢʀᴏᴜᴘ & ᴡᴀɪᴛ ꜰᴏʀ ɪᴛ ᴛᴏ ᴀᴄᴄᴇᴘᴛ ᴏʀ ᴅɪʀᴇᴄᴛʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴛᴏ ᴏᴡɴᴇʀ ᴀꜰᴛᴇʀ ʀᴇQᴜᴇꜱᴛ @Matiz_Owner
...
/fsub -100xxxxxxxxxx</b>"""

    ABOUT = """
✯ Mʏ Nᴀᴍᴇ:  {}
✯ Cʀᴇᴀᴛᴏʀ: <a href='https://t.me/Matiz_Owner'>ᴍᴅ ᴍᴀᴛɪɴ</a>
